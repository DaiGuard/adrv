...
#echo "Remote: $1"
echo "Remote: 10.42.0.102"
#echo "Host  : $2"
echo "Host  : 10.42.0.101"

#echo "export ROS_IP=$1"
echo "export ROS_IP=10.42.0.102"
#echo "export ROS_MASTER_URI=http://$2:11311"
echo "export ROS_MASTER_URI=http://10.42.0.101:11311"
#export ROS_IP=$1
export ROS_IP=10.42.0.102
#export ROS_MASTER_URI=http://$2:11311
export ROS_MASTER_URI=http://10.42.0.101:11311
